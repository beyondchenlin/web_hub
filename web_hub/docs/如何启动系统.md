...
```bash
# 进入集群监控系统目录
cd d:\index-tts-2-6G-0914\index-tts-2\web_hub\cluster_monitor
...
```bash
# 进入项目目录
cd d:\index-tts-2-6G-0914\index-tts-2\web_hub

# 启动工作节点
python start_lightweight.py --port 8005

# 多台机器示例
python start_lightweight.py --port 8006  # 机器2
python start_lightweight.py --port 8007  # 机器3
```
